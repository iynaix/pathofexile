...
Elm.Html.Shorthand.make = function (_elm) {
   ...
   var option$ = function (p) {
      ...
      _L.fromArray([A2($Html$Attributes$Extra.stringProperty,
                   "label",
                   p.label)
   ...
   var inputInt$ = function (p) {
      return function () {
         ...
         filterJust(_L.fromArray([A2($Maybe.map,
                                 ...
                                 ,A2($Maybe.map,
                                 function ($) {
                                    return $Html$Attributes$Extra.stringProperty("step")($Basics.toString($));
                                 },
                                 p.step)]))));
      }();
   };
...
Elm.Item.make = function (_elm) {
   ...
   var decodeLocation = A6($Json$Decode.object5,
   Location,
   A2($Json$Decode._op[":="],
   "id",
   $Json$Decode.$int),
   ...
   "is_premium",
   $Json$Decode.bool));
   var fetchLocations = function (url) {
      return A2($Http.get,
      $Json$Decode.list(decodeLocation),
      "/api/locations/");
   };
